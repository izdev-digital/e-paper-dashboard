...
public static class Constants
{
    ...
    public const string PlaywrightComponentHttpClientName = nameof(PlaywrightComponentHttpClientName);

    public const string SsrImageHttpClientName = nameof(SsrImageHttpClientName);
